...
export const EVENT_DATE_ISO = '2026-08-20T19:00:00+05:00';
export const EVENT_YEAR = 2026;
export const EVENT_MONTH = 8; // тамыз (1-12)
export const EVENT_DAY = 20;

export const EVENT_DATE_LABEL = '20 тамыз 2026';
export const EVENT_TIME_LABEL = '19:00';
