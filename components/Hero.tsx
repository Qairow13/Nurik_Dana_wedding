...
export default function Hero() {
  return (
    <section
      className="relative flex min-h-[100vh] items-center justify-center overflow-hidden bg-[#c4933a]"
      style={{
        backgroundImage: "url('/images/hero.jpg'), var(--gold-gradient)",
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-3 border border-cream-100/40 sm:inset-6" />

      <div className="relative z-10 mx-auto flex flex-col items-center px-6 text-center text-cream-50">
        <p className="animate-fadeIn text-xs uppercase tracking-[0.35em] text-cream-100 sm:text-sm">
          Үйлену тойы
        </p>
        ...
        <FlourishDivider className="animate-fadeIn animate-delay-300 mt-6 text-cream-100" />
